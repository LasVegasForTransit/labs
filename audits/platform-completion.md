...
| Migrate                             | Fresh repository; provenance; CI/rules; stable route verification; deployment ownership transfer; catalog-only source removal; rollback     | Export, Labs pause, guarded destination enablement, exact-commit dispatch, standalone deployment, and stable-route verification pass locally; remote provisioning, live verification, finalization, and rollback remain pending |
...
| PR previews                         | Existing Worker versions; temporary new Workers; close cleanup; staging for stateful apps                                                   | Version and temporary preview workflows, verification, comments, and owned cleanup pass locally; credentialed CI and stateful staging remain pending                                                                            |
...
| Accessibility and visual acceptance | Axe, keyboard, reduced motion, console/network, desktop/mobile screenshots and baselines                                                    | Keyboard, reduced-motion, console/network, responsive, and archive checks exist; axe and durable screenshot baselines remain incomplete                                                                                         |
