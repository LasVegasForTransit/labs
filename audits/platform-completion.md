...
| Migrate                             | Fresh repository; provenance; CI/rules; stable route verification; deployment ownership transfer; catalog-only source removal; rollback     | Standalone export and the Labs ownership pause pass locally; remote provisioning, destination transfer, live verification, and finalization remain pending |
