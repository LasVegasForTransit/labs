...
| Create                              | Both profiles generated from the pinned preset; guided and non-interactive flows; checks and browser tests pass                             | Manifest-driven local generator exists; preset integration and guided prompts pending                                    |
